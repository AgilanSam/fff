...
void lemlib::Chassis::moveWithAssignedSpeed (double linVel, double turnVel)
{
  drivetrain.leftMotors->move( ((linVel-turnVel)/100)*12000);
  drivetrain.rightMotors->move( ((linVel+turnVel)/100)*12000);
}
